...
def set_efficient_attention_backend(backend: str = 'torch'):
    ...
    if backend == 'xformers' and (not _has_xformers or not torch.cuda.is_available()):
        print("⚠️ xformers backend requested but unavailable for this device - falling back to torch")
        backend = 'torch'
