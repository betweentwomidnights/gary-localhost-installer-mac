...
class MlxVaeInitMixin:
    ...
    def _init_mlx_vae(self) -> bool:
        ...
        Side effects:
            ...
            ``self._mlx_compiled_encode_mean``, and ``self._mlx_vae_dtype``.
        ...
        try:
            ...
            try:
                ...
                self._mlx_compiled_encode_mean = mx.compile(mlx_vae.encode_mean)
                ...
                self._mlx_compiled_encode_mean = mlx_vae.encode_mean
            ...
            self._mlx_compiled_encode_mean = None
