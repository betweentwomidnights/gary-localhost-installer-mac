...
class _FakeMlxVae:
    ...
    def encode_mean(self, value):
        """Return tagged deterministic encode output."""
        return ("encode_mean", value)
...
class MlxVaeInitMixinTests(unittest.TestCase):
    ...
    def test_init_mlx_vae_success_sets_compiled_callables(self):
        ...
        self.assertEqual(calls["compile"], 3)
    ...
    def test_init_mlx_vae_compile_failure_falls_back(self):
        ...
        self.assertEqual(host._mlx_compiled_encode_mean("x"), host.mlx_vae.encode_mean("x"))
