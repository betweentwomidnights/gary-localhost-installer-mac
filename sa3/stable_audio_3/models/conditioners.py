...
class T5GemmaConditioner(Conditioner):
    T5GEMMA_MODEL_ALIASES = {
        "stabilityai/t5gemma-b-b-ul2": "google/t5gemma-b-b-ul2",
    }

    T5GEMMA_MODELS = ["stabilityai/t5gemma-b-b-ul2", "google/t5gemma-b-b-ul2"]
    ...
    def __init__(
        ...
        load_from = model_path or repo_id or self.T5GEMMA_MODEL_ALIASES.get(model_name, model_name)
